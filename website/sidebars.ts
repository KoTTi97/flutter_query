...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    // Every recipe in `docs/cookbook/`, ordered by its `sidebar_position`;
    // the index page is the category's landing page, and the
    // `sidebarItemsGenerator` in docusaurus.config.ts keeps it out of the
    // list below it.
    {
      type: 'category',
      label: 'Cookbook',
