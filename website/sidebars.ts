...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      ...
      items: [
        'cookbook/wiring-dio-and-http',
        'cookbook/auth-and-token-refresh',
        'cookbook/list-detail-seeding',
        'cookbook/lifecycle-and-connectivity-wiring',
        'cookbook/pull-to-refresh',
        'cookbook/search-as-you-type',
        'cookbook/forms-and-server-validation',
        'cookbook/global-error-snackbar',
        'cookbook/infinite-list-view',
        'cookbook/testing-a-screen',
        'cookbook/riverpod-bloc-provider',
        'cookbook/offline-first-and-persistence',
        'cookbook/dependency-injection',
        'cookbook/routing-go-router',
        'cookbook/realtime-websockets',
        'cookbook/poll-until-confirmed',
        'cookbook/device-and-iot-disconnect',
        'cookbook/sign-out-and-multi-account',
        'cookbook/normalised-vs-per-entity-keys',
        'cookbook/freezed-and-json-models',
      ],
    },
    {
      type: 'category',
