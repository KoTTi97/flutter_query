...
/// long chain, 1.7 s for 50 000 of them. The shifts do not align with a
/// value's two 32-bit halves, so the halves cannot cancel. A function of
/// [hash] alone: two values with equal hash codes still spread to equal
/// results, which is all `==` needs.
@internal
