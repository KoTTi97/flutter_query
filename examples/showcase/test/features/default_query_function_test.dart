...
void main() {
  showcaseTest(
    ...
    expect(find.text('#1 Local development: setup guide'), findsOneWidget);
    ...
    expect(
      find.text('Anna on "Local development: setup guide": Worked on the first '
          'try.'),
      findsOneWidget,
    );
    expect(
      find.text('Ben on "Local development: setup guide": Connected on the '
          'second attempt.'),
      findsOneWidget,
    );
    expect(
      find.text('Clara on "Local development: setup guide": Needs a rebuild.'),
      findsOneWidget,
    );
